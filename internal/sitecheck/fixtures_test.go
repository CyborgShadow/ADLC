...
<p class="big">Cats purr when they are content and also when they are hurt or frightened. Whether the low frequency helps bone heal is a maybe, not a finding.</p>
</section>
...
<p class="big">Calm, wanted contact is linked with a rise in oxytocin for the person and the cat. Wanted is the load bearing word here.</p>
...
<p class="little">A cat often picks one person in a house.</p>
...
<h2>Sources</h2>
<ul>
<li id="s1">Archer, on infant facial schemas.</li>
<li id="s2">Remmers, on purr acoustics.</li>
<li id="s3">Nagasawa, on oxytocin and contact.</li>
<li id="s4">Ottoni, on cat commensalism.</li>
<li id="s5">Turner, on cat and owner bonds.</li>
</ul>
</section>
</body>
</html>
